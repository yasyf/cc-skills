...
| `repo` | no | `owner/repo` on GitHub, the repository the doc's links default to: a link into it renders as `#17567`, one anywhere else as `owner/repo#17567`; `check` errors on any other shape |
