...
# Provision the {{BINARY_NAME}} binary for the {{PLUGIN_NAME}} plugin.
#
# bin/{{BINARY_NAME}} is only ever a symlink — to a brew-installed binary, the
