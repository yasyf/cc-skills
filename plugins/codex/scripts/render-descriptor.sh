#!/bin/sh
# GENERATED by cc-guides from .claude/fragments/plugins/codex/scripts/render-descriptor.sh/ — do not edit; edit the fragments and push — CI renders.
# Render descriptor/codex-ask.binrun.tmpl into a concrete codex-ask.binrun,
...
# "codex-ask_<version>_<os>_<arch>.tar.gz", the shape binrun ships. A plugin
...
tmpl="$here/descriptor/codex-ask.binrun.tmpl"
...
for pair in MACOS_AARCH64:darwin_arm64 MACOS_X86_64:darwin_amd64 LINUX_X86_64:linux_amd64 LINUX_AARCH64:linux_arm64; do
  key="${pair%%:*}"
  osarch="${pair##*:}"
  name="codex-ask_${version}_${osarch}.tar.gz"
...
[ "$matched" -gt 0 ] || { echo "render-descriptor: no codex-ask_${version}_<os>_<arch>.tar.gz archives in $checksums" >&2; exit 1; }
