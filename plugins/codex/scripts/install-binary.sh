#!/bin/bash
# GENERATED by cc-guides from .claude/fragments/plugins/codex/scripts/install-binary.sh/ — do not edit; edit the fragments and push — CI renders.
# Locate the binrun runner and exec the codex-ask descriptor.
#
# This renders to plugin scripts/install-binary.sh — the successor to the
# provision-a-symlink installer. bin/codex-ask is a committed symlink to it, so
...
# resolves and execs the version-exact artifact the sidecar bin/codex-ask.binrun
