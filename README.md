...
| [design-doc](plugins/design-doc) | An assumptions-first design method with stable-ID registers and question rounds, shipped as an interactive doc with readable citations, declared components, PR links with live GitHub state, an interview replay, and a whole-document assistant behind a deployed key, plus a PDF. Needs Chrome for the PDF step. |
