...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param("docs/getting-started/install.html", "narrative", id="docs-getting-started"),
        pytest.param("docs/tutorial/first-block.html", "narrative", id="docs-tutorial"),
        pytest.param("docs/guide/widgets.html", "narrative", id="docs-guide"),
        pytest.param("docs/cheatsheet/index.html", "narrative", id="docs-cheatsheet"),
        pytest.param("docs/examples/basic.html", "narrative", id="docs-examples"),
        pytest.param("index.html", "narrative", id="site-index"),
        pytest.param("reference/widget.html", "reference", id="reference"),
        pytest.param("docs/reference/events.html", "other", id="docs-reference-neutral"),
